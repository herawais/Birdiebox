...
class ResConfigSettings(models.TransientModel):
    ...
    update_account_import = fields.Boolean(String='Update Account While Import', default=False)
    update_account_export = fields.Boolean(String='Update Account While Export', default=False)
